def Account_creator(path_deriver):
    try:    
        ...
        path  = '/Users/meisamghafary/Desktop/Squad/instagram-auto-create-account-master/chromedriver'
        # chrome_options = webdriver.ChromeOptions()
        # ua = UserAgent()
        # userAgent = ua.random
        # chrome_options.add_argument(f'user-agent={userAgent}')

        email_driver = webdriver.Chrome(path_deriver, options=chrome_options)
        email_driver.get("https://fakermail.com/")
        
        #saves the login & pass into accounts.txt file.
        driver = webdriver.Chrome(path_deriver, chrome_options=chrome_options)
        ...
        while len(message)<1:
            ...
            second_time = start_time - time.time()
            if second_time - start_time> 300:
                break
